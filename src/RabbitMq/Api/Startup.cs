...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.InitializeProductServiceClients<AppSettings>();
        services.InitializeCustomerServiceClients<AppSettings>();
        services.InitializeOrderServiceClients<AppSettings>();
